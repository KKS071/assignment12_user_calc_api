...
class User(Base):
    ...
    def update(self, **kwargs):
        """Update user fields and refresh updated_at."""
    ...
    def register(cls, db, user_data: dict) -> "User":
        ...
        Raises ValueError if the password is too short or the email/username is taken.
        """
    ...
    def authenticate(cls, db, username_or_email: str, password: str):
        ...
        Returns a dict with tokens and user info on success, or None on failure.
        """
    ...
    def verify_token(cls, token: str):
        """
        Decode a JWT token.
        Returns the user UUID on success, or None if the token is invalid.
        """
        try:
            payload = jwt.decode(
